...
var cards = [];
var cardsName = ['fa fa-anchor', 'fa fa-anchor', 'fa fa-bicycle', 'fa fa-bolt', 'fa fa-cube', 'fa fa-diamond', 'fa fa-diamond', 'fa fa-plane', 'fa fa-leaf', 'fa fa-bomb', 'fa fa-leaf', 'fa fa-bomb', 'fa fa-bolt', 'fa fa-bicycle', 'fa fa-plane', 'fa fa-cube'];
var openCards = [];
            ...
            setTimeout(function() {
                $('.deck').each(function() {
                    ...
                    swal({
                        title: 'You Did It!',
                        type: 'success',
                        text: 'Congratulations! Moves conceded are ' + moves + '. You got ' + stars + ' stars! Your time taken was ' + hours + ' hours ' + min + ' minutes and ' + sec + ' seconds.',
